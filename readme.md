...
1. Participant picks a language. Patient ID is entered.
...
config.js          settings for this site, can be edited to change languages, regions, number of concepts needed, `patientIdEntry`, `emailEnabled`
